                ...
                <div class="tab-pane active" id="update-url">
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <tr>
                                <td>PUT</td>
                                <td>http://paymentgateway.polindra.ac.id/api/v1/pembayaran_lainnya/{regis_number}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                ...
                <div class="tab-pane active" id="notifikasi-url">
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <tr>
                                <td>POST</td>
                                <td>http://payment-gateway.polindra.ac.id/api/v1/notification</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                ...
                <div class="tab-pane active" id="get-url">
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <tr>
                                <td>POST</td>
                                <td>http://payment-gateway.polindra.ac.id/api/v1/DataTransactions</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                ...
                <div class="tab-pane active" id="get-detail-url">
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <tr>
                                <td>POST</td>
                                <td>http://payment-gateway.polindra.ac.id/api/v1/DataDetailTransactions</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
...
<br><br><br>
        <div class="alert alert-info">
            <p>Jika ada yang ingin di konfirmasi silahkan hubungi <a data-tjr-open-modal="contact-info-modal" href="#open-info-dialog-modal">kontak support</a></p>
        </div>
    </div>
</div>
